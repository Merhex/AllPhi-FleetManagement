...
namespace FleetManagement.BLL.MotorVehicles.Components
{
    public class MotorVehicleComponent : IMotorVehicleComponent
    {
        ...
        public async Task<IComponentResponse> CreateLicensePlateAsync(ILicensePlateContract contract, CancellationToken cancellationToken)
        {
        ...
        public Task<IComponentResponse> WithdrawLicensePlateFromMotorVehicleAsync(IWithdrawLicensePlateContract contract, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        public Task<IComponentResponse> DeleteLicensePlateAsync(IDeleteLicensePlateContract contract, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        public Task<IComponentResponse> ChangeLicensePlateInUseStatusAsync(IChangeLicensePlateInUseStatusContract contract, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<IComponentResponse> ChangeMotorVehicleOperationalStatusAsync(IChangeMotorVehicleOperationalStatusContract contract, CancellationToken cancellationToken)
        {
            ...
            if (listenerResponse.Success)
            {
                await ChangeMotorVehicleOperationalStatus(contract, cancellationToken);
        ...
        #region PRIVATE
        private async Task CreateNewLicensePlateBasedOn(ILicensePlateContract contract)
        {
        ...
        private async Task ChangeMotorVehicleOperationalStatus(IChangeMotorVehicleOperationalStatusContract contract, CancellationToken token)
        {
        ...
        //private async Task ChangeMotorVehicleOperationalStatus(IChangeMotorVehicleOperationalStatusContract contract, CancellationToken token)
        //{
        //    var motorVehicle = await _motorVehicleRepository.FindByChassisNumberAsync(contract.ChassisNumber, )
        //}
